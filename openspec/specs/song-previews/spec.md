# song-previews Specification

## Purpose
Define how the backend resolves a band's configured track id to a 30-second preview URL from the iTunes Lookup API. Resolution is unauthenticated and requires no API key or secret.

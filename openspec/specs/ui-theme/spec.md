...
## Purpose
Define a shared modern-retro visual system — palette, fonts loaded before first render, reusable component styles, subtle CRT accents, and smooth scene transitions — applied consistently across all scenes.

...
## Purpose
Define how the game is built into a static production bundle, packaged into a rootless OpenShift-compatible container image, served over HTTP, and documented for build/run/configuration.
